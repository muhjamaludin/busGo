...
class EditSchedule extends Component{
  ...
  async componentDidMount(){
    const results = await axios.get(config.APP_BACKEND.concat(`agents/${this.props.match.params.id}`))
    ...
    this.submitData = async (e)=>{
      ...
      const submit = await axios.patch(config.APP_BACKEND.concat(`agents/${this.props.match.params.id}`),qs.stringify(this.state.data))
